    ...
    return (
        <div className="dashboard-card border-surfaceHighlight/30 mt-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="flex justify-between items-center mb-10 relative z-10 p-2">
                ...
                <button className="text-[10px] font-black text-primary hover:text-primaryHighlight flex items-center gap-2 uppercase tracking-widest transition-all bg-primary/10 px-4 py-2 rounded-xl border border-primary/20 hover:scale-105 active:scale-95">
                            ...
                            >
                                ...
                                <td className="py-6 px-4 pl-8">
                                    <div className="flex items-start gap-4">
                                        <div className="mt-1 p-2 bg-background/50 rounded-lg group-hover/row:bg-primary/20 group-hover/row:text-primary transition-colors">
