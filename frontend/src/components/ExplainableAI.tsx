                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="relative w-full max-w-sm">
                            <input
                                ...
                                className="w-full bg-background border border-surfaceHighlight rounded-2xl pl-12 pr-4 py-4 text-sm focus:outline-none focus:border-primary text-text-main font-mono transition-all"
                                placeholder="E.g. 412561"
                            />
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className={`px-10 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${isLoading
                                ? 'bg-surfaceHighlight text-text-muted'
                                : 'bg-primary text-white hover:shadow-[0_0_30px_rgba(59,130,246,0.4)]'
                                }`}
                        >
