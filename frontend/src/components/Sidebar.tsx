...
export function Sidebar({ currentTab, setCurrentTab, userRole }: SidebarProps) {
    ...
    const filteredNavItems = navItems.filter(item => {
        if (item.id === 'architecture' && userRole !== 'admin') {
            return false;
        }
        return true;
    });
    ...
    return (
        <div className="w-64 h-screen bg-surface border-r border-surfaceHighlight/50 flex flex-col fixed left-0 top-0 z-40 transition-colors duration-300">
            <div className="p-8">
